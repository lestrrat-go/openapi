...
func (b *OperationBuilder) Tags(v ...Tag) *OperationBuilder {
	b.target.tags = v
	return b
}
...
func (b *OperationBuilder) Consumes(v ...string) *OperationBuilder {
	b.target.consumes = v
	return b
}

// Produces sets the Produces field for object Operation.
func (b *OperationBuilder) Produces(v ...string) *OperationBuilder {
	b.target.produces = v
	return b
}
...
func (b *OperationBuilder) Schemes(v ...string) *OperationBuilder {
	b.target.schemes = v
	return b
}

...
// Get finalizes the matuation process for Header and returns the result
...
func (b *HeaderMutator) Example(v interface{}) *HeaderMutator {
	b.proxy.example = v
	return b
}

// Examples sets the Examples field for object Header.
func (b *HeaderMutator) Examples(v map[string]Example) *HeaderMutator {
	b.proxy.examples = v
	return b
}

// Content sets the Content field for object Header.
func (b *HeaderMutator) Content(v map[string]MediaType) *HeaderMutator {
	b.proxy.content = v
	return b
}
